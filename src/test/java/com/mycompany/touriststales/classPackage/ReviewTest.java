...
public class ReviewTest {
    ...
    public void testGetId() {
        ...
        Integer result = -1;
        Integer expResult = 1;
        String s = new test().capitalize("testons");
        try{
            //Review instance = this.myDB.get_review_by_id("1").getId();
            result = this.myDB.get_review_by_id("1").getId();
        }catch(Exception ex){
            //result = -1;
            System.err.println("Achille: " + ex.getMessage() + "\n" + s);
        }
