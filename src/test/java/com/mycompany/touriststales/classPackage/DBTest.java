...
public class DBTest {
    ...
    public void testGetInstance() {
        ...
        System.err.println("DBTESTexpResults: " + expResult.err);
    ...
    /**
     * Test of log_in method, of class DB.
     */
    @Test
    public void testLog_in() throws Exception {
        System.out.println("log_in");
        String user_name = "";
        String password = "";
        DB instance = new DB();
        Author expResult = null;
        Author result = instance.log_in(user_name, password);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    /**
     * Test of get_n_reviews_by_cathegory method, of class DB.
     */
    @Test
    public void testGet_n_reviews_by_cathegory() throws Exception {
        System.out.println("get_n_reviews_by_cathegory");
        int n = 0;
        String category = "";
        DB instance = new DB();
        Review[] expResult = null;
        Review[] result = instance.get_n_reviews_by_cathegory(n, category);
        assertArrayEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    /**
     * Test of get_n_reviews_by_term method, of class DB.
     */
    @Test
    public void testGet_n_reviews_by_term() throws Exception {
        System.out.println("get_n_reviews_by_term");
        int n = 0;
        String term = "";
        DB instance = new DB();
        Review[] expResult = null;
        Review[] result = instance.get_n_reviews_by_term(n, term);
        assertArrayEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    /**
     * Test of get_n_reviews method, of class DB.
     */
    @Test
    public void testGet_n_reviews() throws Exception {
        System.out.println("get_n_reviews");
        int n = 0;
        DB instance = new DB();
        Review[] expResult = null;
        Review[] result = instance.get_n_reviews(n);
        assertArrayEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    /**
     * Test of get_tale_by_id method, of class DB.
     */
    @Test
    public void testGet_tale_by_id() throws Exception {
        System.out.println("get_tale_by_id");
        String id = "";
        DB instance = new DB();
        Tale expResult = null;
        Tale result = instance.get_tale_by_id(id);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
